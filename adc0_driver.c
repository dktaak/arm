...
void adc0_init(void)
{
	PINSEL0|=0x300;//11 0000 0000//P0.4 SELECT AS ADC0.6 CHANNEL
...
u32 adc0_read(void)
{
	...
	//TABLE NO.285
	while((AD0DR6 & ADC_DONE)==0);//WAITING HERE FOR CONVERSION TO COMPLETE(31ST BIT SHOW COMPLETION)
	AD0CR&=(~(1<<24));//STOP ADC0.6
	val=((AD0DR6>>6)&0X3FF);//6TH TO 15TH BIT SHOWS THE RECENT RESULT SO MASKING
